...
export default function ITPPage() {
  return (
    <>
      ...
      <ServiceHero heading={data.hero.heading} subheading={data.hero.subheading} ctaLabel="Programează ITP" secondaryCtaLabel="Service Rapid" secondaryCtaHref="/service-auto-rapid-huedin" backgroundImage="/images/tyrefix/new-service-itp-huedin.webp" />
