...
export default function ReglajDirectiePage() {
  return (
    <>
      ...
      <ServiceHero heading={data.hero.heading} subheading={data.hero.subheading} secondaryCtaLabel="Service Auto Rapid" secondaryCtaHref="/service-auto-rapid-huedin" backgroundImage="/images/tyrefix/vulcanizare-huedin-2.webp" />
